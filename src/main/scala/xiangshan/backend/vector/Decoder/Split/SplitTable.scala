...
//    }
  ...
  val table: SeqMap[BitPat, SeqMap[SewLmulPattern, Seq[Opcode]]] = {
    ...
    val opf01Table = SeqMap[BitPat, SeqMap[SewLmulPattern, Seq[Opcode]]](
      ...
      VFMV_S_F -> SeqMap.from(
        Seq(
          ...
          val uop = _uop.copy() - Src1Gp + Src1Fp
          val leM1Uops = for (lmul <- Seq(mf8, mf4, mf2, m1)) yield {
            (sew ## lmul) -> Seq(uop)
          }
          val m2Uops = (sew ## m2) -> (uop +: Seq.fill(1)(vtail))
    ...
    val cryptoTable = SeqMap[BitPat, SeqMap[SewLmulPattern, Seq[Opcode]]](
      ...
      VAESZ_VS -> dup(null, null, vaesz, null)(identity),
      VAESDF_VS -> dup(null, null, vaesdf, null)(identity),
      VAESDF_VV -> dup(null, null, vaesdf, null)(identity),
      VAESDM_VS -> dup(null, null, vaesdm, null)(identity),
      VAESDM_VV -> dup(null, null, vaesdm, null)(identity),
      VAESEF_VS -> dup(null, null, vaesef, null)(identity),
      VAESEF_VV -> dup(null, null, vaesef, null)(identity),
      VAESEM_VS -> dup(null, null, vaesem, null)(identity),
      VAESEM_VV -> dup(null, null, vaesem, null)(identity),
      VAESKF1_VI -> dup(null, null, vaeskf1, null)(_.vui),
      VAESKF2_VI -> dup(null, null, vaeskf2, null)(_.vui),
      VGHSH_VV -> dup(null, null, vghsh, null)(_.S1v),
      VGMUL_VV -> dup(null, null, vgmul, null)(identity),
      VSM4R_VV -> dup(null, null, vsm4r, null)(identity),
      VSM4R_VS -> dup(null, null, vsm4r, null)(identity),
      VSM4K_VI -> dup(null, null, vsm4k, null)(_.vui),
    )
